...
def animar(i, est, T, ax1, ax2, tiempo_total, presion_aortica, volumen_ventricular, paso=10):
...
def Principal(est):
    ...
    anim = FuncAnimation(
        fig,
        animar,
        frames=len(tiempo_total) // 100,  # Dividir en intervalos de 10 para avanzar más rápido
